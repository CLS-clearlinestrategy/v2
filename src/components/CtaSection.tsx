  ...
  return (
    <section className="relative section-padding bg-primary overflow-hidden">
      ...
      <div className="container-narrow text-center relative z-10">
        ...
        >
          <p className="mb-6 font-body text-xs md:text-sm tracking-[0.3em] uppercase text-accent">
            Próximo Passo
          </p>
          ...
          <p className="mx-auto max-w-xl font-body text-sm md:text-lg text-primary-foreground/80 leading-loose mb-10 md:mb-14">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-5">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto inline-block rounded-md border border-primary-foreground/30 px-8 py-3 sm:px-12 sm:py-4 font-body text-xs sm:text-sm tracking-[0.2em] uppercase text-primary-foreground/90 transition-all duration-500 hover:border-accent hover:text-accent"
            >
              Falar com a equipe
            </a>
          </div>
